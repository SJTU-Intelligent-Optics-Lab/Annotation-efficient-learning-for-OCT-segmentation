...
def main(train,val):
    ...
    parser.add_argument("--phase2_weight", default="./runs/phase2 model.pth", type=str,help="load phase2 model weight")
    parser.add_argument("--phase1_weight", default="./runs/phase1 model.pth", type=str, help="load phase1 model weight")
